...
export default function Addresses() {
    ...
    const openModal = (address = null) => {
        if (address) {
            ...
            setFormData({
                name: address.name,
                fullName: address.fullName || address.recipient,
                        ...
                        <div key={address.id} className="relative group">
                            ...
                            <div className="bg-[var(--bg)]/40 backdrop-blur-xl border border-[var(--secondary)]/20 rounded-[2.5rem] p-8 sm:p-10 shadow-lg shadow-[var(--secondary)]/5 hover:shadow-2xl hover:-translate-y-1.5 transition-all duration-500 flex flex-col h-full overflow-hidden">
                                ...
                                <div className="flex-grow space-y-2 mb-10">
                                    <p className="font-extrabold text-2xl text-[var(--text)] mb-4">{address.fullName || address.recipient}</p>
                        ...
                        <div className="flex-1 overflow-y-auto custom-scrollbar px-10 py-4">
                            <form id="address-form" onSubmit={handleSubmit} className="space-y-8 pb-4">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    {/* Address Line 1 */}
                                    <div className="space-y-3 md:col-span-2 group">
                                        <label className="text-[11px] font-black uppercase tracking-[0.25em] opacity-40 ml-1 group-focus-within:text-[var(--primary)] group-focus-within:opacity-100 transition-all">Address Line 1</label>
                                        <input 
                                            required
                                            name="address1"
                                    ...
                                    {/* Address Line 2 */}
                                    <div className="space-y-3 md:col-span-2 group">
                                        <label className="text-[11px] font-black uppercase tracking-[0.25em] opacity-40 ml-1 group-focus-within:text-[var(--primary)] group-focus-within:opacity-100 transition-all">Address Line 2 (Optional)</label>
                                        <input 
                                            name="address2"
                                            value={formData.address2}
                                            onChange={handleInputChange}
                                            placeholder="Area, Landmark, Flat (optional)" 
                                            className="w-full bg-[var(--secondary)]/5 border-2 border-transparent focus:border-[var(--primary)] focus:bg-[var(--bg)] focus:shadow-lg p-5 rounded-[1.5rem] outline-none font-bold transition-all shadow-[inset_0_2px_4px_rgba(0,0,0,0.05)] text-lg"
                                        />
                                    </div>
                                    ...
                                    <div className="space-y-3 group">
                                        ...
                                        <select 
                                            ...
                                            onChange={handleInputChange}
                                            className="w-full bg-[var(--secondary)]/5 border-2 border-transparent focus:border-[var(--primary)] focus:bg-[var(--bg)] focus:shadow-lg p-[22px] rounded-[1.5rem] outline-none font-bold transition-all shadow-[inset_0_2px_4px_rgba(0,0,0,0.05)] text-lg appearance-none"
                                        >
