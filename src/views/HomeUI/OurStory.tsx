                ...
                <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                    ...
                    <div className="w-full lg:w-1/2 flex flex-col justify-center relative z-10 pt-10 lg:pt-0">
                        <div className="animate-fade-in-up">
                            ...
                            <Link href="/about" className="group inline-flex items-center justify-center gap-3 font-bold bg-transparent text-[var(--text)] px-8 py-4 border-2 border-[var(--text)] rounded-full w-full sm:w-max hover:bg-[var(--text)] hover:text-[var(--bg)] transition-all duration-300">
