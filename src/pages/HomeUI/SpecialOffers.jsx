                    ...
                    <div className="relative z-10 w-full md:w-2/3 lg:w-1/2 p-10 md:p-16 lg:p-20 text-white">
                        <div className="animate-fade-in-up">
                            ...
                            <div className="flex flex-col sm:flex-row items-center gap-6">
                                <Link to="/products" className="group relative w-full sm:w-auto overflow-hidden rounded-full bg-white px-10 py-4 text-black text-center font-bold tracking-wide shadow-[0_0_40px_rgba(255,255,255,0.2)] transition-all hover:scale-105 hover:shadow-[0_0_60px_rgba(255,255,255,0.4)]">
