        ...
        const fetchProducts = async () => {
            try {
                ...
                if (response.ok) {
                    ...
                    // In a real app, you might use createdAt date sorting
                    // Here we'll filter by isNew if available, or just take the first 10 for demo
                        ...
                        {[...products, ...products].map((product, idx) => (
                            ...
                            >
                                ...
                                <div className="relative aspect-[4/5] overflow-hidden rounded-2xl bg-[var(--secondary)]/5 mb-4 group-hover:shadow-xl transition-shadow duration-300 flex-shrink-0">
                                    <img 
                                        src={product.image || "https://placehold.co/600x800?text=New+Arrival"} 
                                        alt={product.name}
                                ...
                                <div className="flex flex-col flex-1 pl-1">
                                    <span className="text-xs font-medium text-[var(--primary)] opacity-80 uppercase tracking-widest mb-1 block">
                                        {product.categoryName || 'New Collection'}
                                    </span>
