                        ...
                        <div className="flex flex-col gap-6">
                            {cart.map((item) => (
                                <div key={item._id} className="group flex flex-col sm:flex-row items-center gap-6 bg-[var(--bg)] border border-[var(--secondary)]/10 p-4 sm:p-6 rounded-[2rem] shadow-sm hover:shadow-xl transition-all duration-300">
                                    <Link to={`/product/${item._id}`} className="shrink-0 relative h-32 w-32 md:h-40 md:w-40 bg-[var(--secondary)]/5 rounded-2xl overflow-hidden block">
                                    ...
                                    <div className="flex-1 flex flex-col w-full">
                                        <div className="flex justify-between items-start mb-2">
                                            <div>
                                                ...
                                                <p className="text-sm opacity-60 font-medium">{item.categoryName || 'Product'}</p>
                                            </div>
