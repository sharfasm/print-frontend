...
export default function CategoryFAQ({ entity, faqs }: CategoryFAQProps) {
    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="opacity-70 font-medium text-center mb-10 text-sm">
          Frequently asked questions about ordering, custom design setup, and delivery for {entity.name}.
        </p>
