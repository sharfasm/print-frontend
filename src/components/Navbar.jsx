...
const Navbar = () => {
    ...
    const isTransparentPage = location.pathname === '/' || location.pathname === '/about' || location.pathname === '/lookbook' || location.pathname === '/contact' || location.pathname === '/news' || location.pathname === '/products';
        ...
        <nav className={navClass}>
            <div className="flex items-center justify-between w-full px-6 md:px-10 lg:px-14 py-4 md:py-5">
                ...
                <div className="flex items-center w-1/4">
                    <Link to="/" onClick={() => setIsMobileMenuOpen(false)} className="text-2xl font-bold tracking-tighter hover:opacity-70 transition-opacity whitespace-nowrap uppercase">
                        {brandName} STORE
                    </Link>
                </div>
                ...
                <div className="flex items-center justify-end gap-5 md:gap-7 w-3/4 md:w-1/4">
                    ...
                    <div className="flex items-center gap-4 pl-4 border-gray-300/30">
                        <Link to="/products" onClick={() => setIsMobileMenuOpen(false)} className="group flex items-center justify-center gap-2 hover:opacity-70 transition-all duration-300">
                        ...
                        {isLoggedIn ? (
                            <div className="relative group py-2 flex items-center">
                                <Link to="/dashboard" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center justify-center gap-2 hover:opacity-70 transition-all duration-300">
                                ...
                                <div className="absolute right-0 top-full w-48 bg-[var(--bg)] text-[var(--text)] border border-[var(--secondary)]/10 rounded-xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 translate-y-2 group-hover:translate-y-0 z-50 flex flex-col py-2 mt-2">
                                    <Link to="/dashboard" onClick={() => setIsMobileMenuOpen(false)} className="px-5 py-2.5 hover:bg-[var(--secondary)]/5 text-sm font-bold opacity-80 hover:opacity-100 hover:text-[var(--primary)] transition-all border-b border-[var(--secondary)]/5">
                                        Account
                                    </Link>
                                    <Link to="/dashboard/orders" onClick={() => setIsMobileMenuOpen(false)} className="px-5 py-2.5 hover:bg-[var(--secondary)]/5 text-sm font-bold opacity-80 hover:opacity-100 hover:text-[var(--primary)] transition-all border-b border-[var(--secondary)]/5">
                                        Orders
                                    </Link>
                                    <button 
                                        onClick={() => {
                            ...
                            <div className="relative group py-2 flex items-center">
                                <Link to="/login" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center justify-center gap-2 hover:opacity-70 transition-all duration-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 shrink-0">
                                ...
                                <div className="absolute right-0 top-full w-48 bg-[var(--bg)] text-[var(--text)] border border-[var(--secondary)]/10 rounded-xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 translate-y-2 group-hover:translate-y-0 z-50 flex flex-col py-2 mt-2">
                                    <Link to="/login" onClick={() => setIsMobileMenuOpen(false)} className="px-5 py-2.5 hover:bg-[var(--secondary)]/5 text-sm font-bold opacity-80 hover:opacity-100 hover:text-[var(--primary)] transition-all border-b border-[var(--secondary)]/5">
                                        Sign In
                                    </Link>
                                    <Link to="/register" onClick={() => setIsMobileMenuOpen(false)} className="px-5 py-2.5 hover:bg-[var(--secondary)]/5 text-sm font-bold opacity-80 hover:opacity-100 hover:text-[var(--primary)] transition-all">
                                        Sign Up
                                    </Link>
                                </div>
                            </div>
                        ...
                        <button 
                            onClick={() => {
                                if (!isLoggedIn) {
                                    ...
                                    setIsMobileMenuOpen(false);
                                    // Normally this would navigate, but for now we follow the guard logic
                                    navigate("/wishlist");
                                }
                            }} 
