            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16 relative z-10">
                ...
                <div className="flex flex-col">
                    ...
                    <ul className="space-y-4 text-sm font-semibold">
                        <li><Link href="/" className="hover:text-[var(--primary)] transition-colors inline-block relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-px after:bg-[var(--primary)] hover:after:w-full after:transition-all after:duration-300">Home</Link></li>
                        <li><Link href="/products" className="hover:text-[var(--primary)] transition-colors inline-block relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-px after:bg-[var(--primary)] hover:after:w-full after:transition-all after:duration-300">All Products</Link></li>
                        <li><Link href="/about" className="hover:text-[var(--primary)] transition-colors inline-block relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-px after:bg-[var(--primary)] hover:after:w-full after:transition-all after:duration-300">Our Story</Link></li>
                        <li><Link href="/dashboard" className="hover:text-[var(--primary)] transition-colors inline-block relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-px after:bg-[var(--primary)] hover:after:w-full after:transition-all after:duration-300">Account</Link></li>
                    </ul>
                </div>
                ...
                <div className="flex flex-col">
                    ...
                    <ul className="space-y-4 text-sm font-semibold">
                        <li><Link href="/faq" className="hover:text-[var(--primary)] transition-colors inline-block relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-px after:bg-[var(--primary)] hover:after:w-full after:transition-all after:duration-300">FAQ & Guides</Link></li>
                        <li><Link href="/dashboard/orders" className="hover:text-[var(--primary)] transition-colors inline-block relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-px after:bg-[var(--primary)] hover:after:w-full after:transition-all after:duration-300">Track Order</Link></li>
                        <li><Link href="/returns" className="hover:text-[var(--primary)] transition-colors inline-block relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-px after:bg-[var(--primary)] hover:after:w-full after:transition-all after:duration-300">Returns & Refunds</Link></li>
                        <li><Link href="/legal" className="hover:text-[var(--primary)] transition-colors inline-block relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-px after:bg-[var(--primary)] hover:after:w-full after:transition-all after:duration-300">Terms & Privacy</Link></li>
                    </ul>
                </div>
